...
import 'adddriversalary.dart';
import 'addexpense.dart';


class SalaryDrivers extends StatefulWidget {
  const SalaryDrivers({Key? key}) : super(key: key);

  @override
  State<SalaryDrivers> createState() => _SalaryDriversState();
}

class _SalaryDriversState extends State<SalaryDrivers> {
                ...
                child: Card(
                  ...
                  child: ListTile(
                    onTap: (){
                      ...
                      Get.to(()=> AddDrivesSalary(driver:controller.allDrivers[index]['user'].toString(),username:controller.allDrivers[index]['username']));
                    },
